...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    // Brand
    "s3v", "s3v.no", "world.s3v.no",
  ],
  authors: [{ name: "S3V", url: SITE_URL }],
  creator: "S3V",
  publisher: "S3V",
  robots: {
    index: true,
  ...
  other: {
    ...
    "apple-mobile-web-app-title": "S3V",
...
const jsonLd = {
  ...
  featureList: [
    ...
    "Worldwide CCTV camera monitoring (27,000+ feeds)",
